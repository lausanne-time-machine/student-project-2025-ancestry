...
RECENS_FILE = f'withjobnorm.csv'  # Path to the recens file
ALL_METIERS_FILE = f'all_metiers1.csv'  # Path to the all_metiers file
OUTPUT_FILE = f'withjobid2.csv'  # Output file name
UNMATCHED_OUTPUT_FILE = f'unmatch2.txt'  # File to save unmatched items
NAMEOFROW='son_job'
NAMEOFOUTPUT='son_job_id'
